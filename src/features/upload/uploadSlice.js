...
export const uploadFile = createAsyncThunk("admin/upload", async (files, thunkApi)=>{
    try {
...
export const deleteFile = createAsyncThunk("admin/upload/delete", async (id, thunkApi)=>{
    try {
